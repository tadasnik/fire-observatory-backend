...
data_file = "/Users/tadas/modFire/fire_lc_ndvi/data/cehlc/results/uk_fwi_variables_2000_2023.parquet"
...
for column in columns:
    dfrg[column] = dfrg[column].round(0).astype("uint16")
...
with open("fire_weather_region_int_2023_11_02.json", "w") as outfile:
